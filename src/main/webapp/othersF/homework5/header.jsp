...
<table width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td height="78" style="background-color:#788dad;
            ...
            <img src="${pageContext.request.contextPath}/othersF/homework5/logo.jpg" align="left">
        </td>
    </tr>
    <tr>
...
<%--            <a style="color:white;" href="${pageContext.request.contextPath}">Home</a>--%>
            - <a style="color:white;" href="${pageContext.request.contextPath}/othersF/homework5/login.jsp">Login</a>
    ...
    <tr height="20"><td align="right">
        ...
        <a href="${pageContext.request.contextPath}/othersF/homework2/register.jsp">Register Here</a>
    </td></tr>
</table>
<br/>
